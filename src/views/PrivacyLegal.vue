<template>
    <section id="privacy-legal">
      <v-ons-page style="height:90vh;">
        <v-ons-list>
          <v-ons-list-header style="font-size: 4vmin; padding-bottom: 3vh">Privacy & Legal
          <v-ons-button id="closeBtn" @click="$router.push('/privacy')">
          ...
          <v-ons-card>
            ...
            <div class="content">
                <b>Last updated August 17, 2020</b>
                <br><br>
                Thank you for choosing to be part of our community at adrianreimer.com
                ...
                or concerns about this privacy notice, or our practices with regards to your
                personal information, please contact us at adrianreimer@protonmail.com.
                <br><br>
                When you use our mobile application, as the case may be (the "App") and more
                generally, use any of our services (the "Services", which include the App),
                we appreciate that you are trusting us with your personal information. We
                take your privacy very seriously. In this privacy notice, we seek to explain
                to you in the clearest way possible what information we collect, how we use it
                and what rights you have in relation to it. We hope you take some time to read
                ...
                through our Services (which, as described above, includes our App), as well as
            ...
            <div class="content">
                <ol>
                    ...
                    <li><b> DO WE COLLECT INFORMATION FROM MINORS? </b></li>
                    <li><b> WHAT ARE YOUR PRIVACY RIGHTS? </b></li>
                    <li><b> CONTROLS FOR DO-NOT-TRACK FEATURES </b></li>
                    <li><b> DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS? </b></li>
                    <li><b> DO WE MAKE UPDATES TO THIS NOTICE? </b></li>
                    <li><b> HOW CAN YOU CONTACT US ABOUT THIS NOTICE? </b></li>
                </ol>
            </div>
            <br>
            <div class="title">
            ...
            <div class="content">
                ...
                on the App or otherwise when you contact us.
                <br><br>
            ...
            <div class="content">
                ...
                use or navigate the App. This information does not reveal your
                ...
                location, information about who and when you use our App and
                ...
                <ul>
                    <li>
                        ...
                        you access or use our App and which we record in log
                        files. Depending on how you interact with us, this
                        log data may include your IP address, device
                        information, browser type and settings and
                        information about your activity in the App (such
                        as the date/time stamps associated with your usage,
                        pages and files viewed, searches and other actions
                        you take such as which features you use), device
            ...
            <div class="content">
                ...
                <br><br>
                <b>In Short: </b> We collect information regarding your
                ...
                <ul>
                    <li>
                        ...
                        mobile device, including your mobile device's
                        microphone, and other features. If you wish to
                    ...
                    <li>
                        ...
                        certain features of the App. If you wish to
            ...
            <div class="content">
                ...
                <br><br>
                We use personal information collected via our App
                ...
                <ul>
                    ...
                    <li>
                        <b>To deliver and facilitate delivery of
            ...
            <div class="content">
                ...
                <ul>
                    <li>
                        <b>Consent:</b>
                        We may process your data if you have given us
                    ...
                    <li>
                        ...
                        believe it is necessary to investigate, prevent,
                        or take action regarding potential violations of
                        our policies, suspected fraud, situations involving
                        potential threats to the safety of any person and
                        illegal activities, or as evidence in litigation
            ...
            <div class="content">
                ...
                (like web beacons and pixels) to access or store information.
                Specific information about how we use such technologies and
                how you can refuse certain cookies is set out in
                our Cookie Notice.
            </div>
            <br>
            <div class="title">
            ...
            <div class="content">
                ...
                delete or anonymize such information, or, if this
            ...
            <div class="content">
                ...
                You should only access the App within a secure environment.
            </div>
            <br>
            <div class="title">
            ...
            <div class="content">
                ...
                to such minor dependent’s use of the App. If we learn
                that personal information from users less than 18 years
                of age has been collected, we will deactivate the account
                and take reasonable measures to promptly delete such data
                from our records. If you become aware of any data we
                may have collected from children under age 18, please
                contact us at adrianreimer@protonmail.com.
            </div>
            <br>
            <div class="title">
            ...
            <div class="content">
                ...
                and obtain a copy of your personal information, (ii)
                to request rectification or erasure; (iii) to restrict
                ...
                the processing of your personal information. To make such
                a request, please use the contact details provided below.
                ...
                certain features or services of our App. To opt-out of interest-based
                advertising by advertisers on our App visit
            ...
            <div class="content">
                ...
                California. We will make sure the data is not publicly displayed on the App,
            ...
            <div class="content">
                ...
                <b>adrianreimer@protonmail.com</b> or by post to:
                <br><br>
                Glatzer Weg 6<br>
                Wolfenbüttel, Lower Saxony 38302<br>
                Germany<br>
            </div>
          </v-ons-card>
        </v-ons-list>
